        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex-shrink-0 flex items-center">
              <Link href="/">
                <h1 className="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-blue-600 bg-clip-text text-transparent hover:from-indigo-500 hover:to-blue-500 transition-all duration-300">
                  EMS
                </h1>
              </Link>
            </div>
          ...
          <div className="max-w-7xl mx-auto h-full flex items-center px-4">
            <div className="text-white space-y-6">
              ...
              <p className="text-xl max-w-2xl">
                Transforming workplace management through innovative solutions
            ...
            <div className="space-y-8">
              <div className="hover:transform hover:translate-y-[-10px] transition-all duration-300">
                ...
                <p className="text-lg text-gray-600">
                  To revolutionize workforce management by providing innovative,
                  user-friendly solutions that empower organizations to maximize
                  their potential.
                </p>
              </div>
              <div className="hover:transform hover:translate-y-[-10px] transition-all duration-300">
                ...
                <p className="text-lg text-gray-600">
                  ...
                  setting new standards for efficiency and workplace harmony.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="p-8 hover:shadow-2xl transition-all duration-300 hover:transform hover:translate-y-[-10px] bg-white"
              >
                <Image
                  src={feature.image}
                  width={400}
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Meet the visionaries behind Indibus EMS, bringing together decades
              of experience in technology, operations, and human resources.
            </p>
          </div>
      ...
      <div className="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-12 max-w-2xl mx-auto">
            Join hundreds of forward-thinking companies who trust Indibus EMS
            for their employee management needs
          </p>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400">
                Leading the future of workforce management
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center">
            <p className="text-gray-400">
              &copy; 2024 Indibus Employee Management System. All rights
              reserved.
            </p>
          </div>
        </div>
...
const features = [
  {
    ...
    description:
      "Gain deep insights into your workforce performance with our AI-powered analytics tools.",
    image:
  ...
  },
  {
    ...
    description:
      "Automate routine tasks and improve operational efficiency with intelligent workflows.",
    image:
  ...
  },
  {
    ...
    description:
      "Enterprise-grade security measures to protect your sensitive employee data.",
    image:
...
const teamMembers = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1556157382-97eda2f9e2bf?q=80&w=2070",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&w=2061",
    linkedIn: "https://linkedin.com",
